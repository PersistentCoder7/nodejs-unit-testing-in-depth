...
describe('users', () => {
    ...
    context('get', () => {
        ...
        it('should call findUserById with id and return the result', () => {
            sandbox.restore();
        ...
        it('should catch error if there is one', (done) => {
            ...
            users.get(123, (err,result)=>{
                ...
                expect(stub).to.be.calledWith(123);
                expect(err.message).to.be.equal('fake');
                done();
            });
        });
    });
    ...
    context('create user', () => {
        ...
        it('shoudl call User with the new keyword', () => {
    ...
    context('update user', () => {
        ...
        it('should reject if there is an eror', async()=>{
